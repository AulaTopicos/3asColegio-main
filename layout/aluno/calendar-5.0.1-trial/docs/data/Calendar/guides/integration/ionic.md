...
[online example browser](https://bryntum.com/examples/calendar/#Integration/Ionic).
...
Another valid method is to pass a [`listeners`](https://bryntum.com/docs/calendar/api/Core/mixin/Events#config-listeners)
