import { EventModel, Combo, ResourceStore, Calendar, CalendarStores, Grid, DateHelper, Month, CrudManager, DomSync, StringHelper } from '../../build/calendar.module.js?457329';
...
const crudManager = new CrudManager({
    ...
    calendar = new Calendar({
        ...
        // We want the overflow popup to show right on top of the calendar cell, so reconfigure
        // its align object.
        modeDefaults : {
            overflowPopup : {
                align : {
