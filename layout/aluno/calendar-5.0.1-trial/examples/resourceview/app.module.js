import { Calendar } from '../../build/calendar.module.js?457329';
                ...
                strips       : {
                    ...
                    resourceInfo : {
                        ...
                        html() {
                            ...
                            return `<span class="weather">${resource.weather}</span><div class="location"><span class="city">${resource.city}</span><span>${resource.temperature}F°</span></div>`;
                        }
                    }
                },
