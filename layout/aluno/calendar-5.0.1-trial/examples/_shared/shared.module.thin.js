import { LocaleManager, Localizable, AsyncHelper, AjaxHelper, DomHelper, Button, Popup, Tooltip, Toast, Widget, BrowserHelper, EventHelper, ResizeHelper, VersionHelper, DataGenerator, Fullscreen, Events, GlobalEvents, Rectangle, TrialButton, Base, Menu } from '../../build/thin/core.module.thin.js?457329';
import '../_shared/product.module.js?457329';
/* global RC */
// Load product config
...
const
    ...
    isModule             = pathName.endsWith('module.html') || (moduleTag?.src.includes('app.module.js?457329')) || (pathName.endsWith('index.html') && isBryntumCom),
...
class CodeEditor extends Popup {
            ...
            tbar : [
                {
                    ...
                    ref      : 'filesCombo',
                    editable : false,
                    value    : isModule ? 'app.module.js?457329' : isUmd ? 'app.umd.js?457329' : 'app.js?457329',
                    items    : [
                        isModule ? 'app.module.js?457329' : isUmd ? 'app.umd.js?457329' : 'app.js?457329'
                    ],
    ...
    async loadCode(filename = isModule ? 'app.module.js?457329' : isUmd ? 'app.umd.js?457329' : 'app.js?457329') {
        const
            me = this;
        ...
        if (filename.endsWith('.js?457329')) {
            me.mode = 'js';
            code = me.processJS(code);
        }
        else if (filename.endsWith('.css?457329')) {
            me.mode = 'css';
    ...
    updateDownloadLink() {
        ...
        downloadLink.href = `data:text/${this.filename.endsWith('.css?457329') ? 'css' : 'javascript'};charset=utf-8,${escape(this.codeElement.innerText)}`;
    }
    ...
    static async addToPage(button) {
        ...
        if (document.head.querySelector('[href$="app.css?457329"]')) {
            filesStore.add({
                text  : 'resources/app.css?457329',
                value : 'resources/app.css?457329'
            });
        }
