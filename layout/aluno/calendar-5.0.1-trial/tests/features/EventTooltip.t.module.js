import { EventStore, ResourceStore, DateHelper, EventModel } from '../../build/calendar.module.js?457329';
...
StartTest(t => {
    ...
    t.it('TOUCH: Should show agenda view event tooltip when tapping', async t => {
        ...
        await t.tap('.b-cal-event-wrap:contains(One)', null, null, { focus : false });
        await t.waitForSelector('.b-sch-event-tooltip:contains(One)');
        await t.tap('.b-cal-agenda-event-time', null, null, { focus : false });
    ...
    t.it('Should not offer delete when Calendar is readOnly', async t => {
        ...
        t.chain(
            ...
            { waitFor : 300, desc : 'The test is that nothing happens. There\'s nothing to wait for' },
