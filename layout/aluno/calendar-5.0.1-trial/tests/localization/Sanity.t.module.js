import { LocaleManager, DateHelper, StringHelper, ObjectHelper } from '../../build/calendar.module.js?457329';
...
StartTest(t => {
    ...
    t.it('Sanity', async t => {
        ...
        for (const mode in calendar.modes) {
            ...
            localeMap.push({ path : `${mode}ShowButton`, locale : `${name}View.${name}` });
        }
