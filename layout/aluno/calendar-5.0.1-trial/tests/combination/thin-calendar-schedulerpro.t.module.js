import { Calendar, SchedulerPro, ProjectModel, DomHelper } from '../../build/calendar.module.js?457329';
...
StartTest(t => {
    ...
    t.it('Calendar + SchedulerPro with thin bundle sanity', async t => {
        ...
        // Ensure css worked
        t.isApproxPx(t.rect('.b-sch-event').left, 665, 2, 'Pro event has correct x');
