import { Calendar, ProjectModel, Scheduler, DomHelper } from '../../build/calendar.module.js?457329';
...
StartTest(t => {
    ...
    t.it('Calendar + Scheduler with thin bundle sanity', async t => {
        ...
        // Ensure css worked
        t.isApproxPx(t.rect('.b-sch-event').left, 665, 2, 'Scheduler event has correct x');
