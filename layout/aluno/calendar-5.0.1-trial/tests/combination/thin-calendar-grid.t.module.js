import { Grid, Calendar, ProjectModel, DomHelper } from '../../build/calendar.module.js?457329';
...
StartTest(t => {
    ...
    t.it('Calendar + Grid with thin bundle sanity', async t => {
        ...
        t.isApproxPx(t.rect('.b-cal-event').left, 603, 2, 'Event has correct x after drag');
