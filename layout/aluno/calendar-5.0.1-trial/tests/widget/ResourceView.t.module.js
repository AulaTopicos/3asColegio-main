import { DomHelper, ObjectHelper } from '../../build/calendar.module.js?457329';
...
StartTest(t => {
    ...
    t.it('Syncing settings which must be shared between all child views', async t => {
        ...
        // 14 visible dys
        t.selectorCountIs('.b-dayview-day-detail.b-calendar-cell:not([data-date="1970-01-01"])', 14);
        ...
        t.selectorCountIs('.b-dayview-day-detail.b-calendar-cell:not([data-date="1970-01-01"])', 4);
    ...
    t.it('allDayEvents row heights must always be in sync', async t => {
        ...
        let allDayHeights = resourceView.items.map(v => v.allDayEvents.height);
        ...
        allDayHeights = resourceView.items.map(v => v.allDayEvents.height);
        ...
        t.is(allDayHeights[0], collapsedHeight);
