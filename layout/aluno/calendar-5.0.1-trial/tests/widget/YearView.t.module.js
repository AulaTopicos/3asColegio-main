import { EventStore, ResourceStore } from '../../build/calendar.module.js?457329';
...
StartTest(t => {
    ...
    t.it('sanity', async t => {
        ...
        // eslint-disable-next-line no-unused-vars
        const firstJanEvent = yearView.eventStore.add({ startDate : new Date(2015, 0, 1), endDate : new Date(2015, 0, 4), name : 'Conference' })[0];
    ...
    t.it('Events must not display in "other month"', async t => {
        ...
        t.chain(
            ...
            next => {
                ...
                t.is(yearView.overflowPopup.lastAlignSpec.target, yearView.contentElement.querySelector('.b-calendar-cell.b-cal-cell-overflow.b-datepicker-1-to-3-events:not(.b-other-month)'), 'Popup aligned  orrectly');
                next();
            },
