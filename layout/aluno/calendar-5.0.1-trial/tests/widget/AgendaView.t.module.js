import { EventStore, ResourceStore, DomHelper, Rectangle } from '../../build/calendar.module.js?457329';
...
StartTest(t => {
    ...
    t.it('sanity', async t => {
        ...
        // Only the recurring events within the range (Which is year) are visible
        t.selectorCountIs('.b-cal-event-body:contains(Recurring Meeting)', 16);
