import { DateHelper, DomHelper, DayTime } from '../../build/calendar.module.js?457329';
...
StartTest(t => {
    ...
    t.it('Events which end at EOD must not be in the all day region', async t => {
        ...
        t.selectorCountIs('.b-dayview .b-dayview-day-container .b-cal-event-wrap:contains(Late dinne)', 1,
