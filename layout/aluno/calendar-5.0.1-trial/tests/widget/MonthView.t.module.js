import { DateHelper, CSSHelper, DomHelper, Rectangle, EventStore, ResourceStore, MonthView } from '../../build/calendar.module.js?457329';
...
StartTest(t => {
    ...
    t.it('sanity', async t => {
        ...
        // These two comples methods should not be run by default.
    ...
    t.it('Week row sizing', async t => {
        ...
        t.is(flexedWeekStart, weekStartDate, 'Event recieved correct date');
