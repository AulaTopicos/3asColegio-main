...
StartTest(t => {
  ...
  t.it('sanity', async t => {
    ...
    t.hasCls(yearView.getCell(new Date()), yearView.todayCls, 'Today class applied to correct cell'); // February starts on a Sunday in 2015, so will only have 4 weeks with weekStartDay = 0.
