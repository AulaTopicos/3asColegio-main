import { EventStore, ResourceStore, DomHelper, DateHelper, Rectangle, ArrayHelper, ObjectHelper } from '../../build/calendar.module.js?457329';
...
StartTest(t => {
    ...
    t.it('Should be able to modify an occurrence maintaining the original COUNT', async t => {
        ...
        // TODO: Remove this when https://github.com/bryntum/bryntum-suite/issues/1672 is fixed
        await t.click('.b-sch-recurrenceconfirmation [data-ref="changeMultipleButton"]');
    ...
    t.it('fitHours in DayView', async t => {
        ...
        const { overflowPopup } = allDayEvents;
    ...
    t.it('should navigate to the day view on click of the overflow popup header', async t => {
        ...
        // Clicking the overflow popup header element should navigate to the day view for that date
