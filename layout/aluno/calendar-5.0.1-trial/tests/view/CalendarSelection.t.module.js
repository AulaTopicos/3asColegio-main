...
StartTest(t => {
    ...
    let calendar, eventStore, resourceStore, agenda, year, month, week, day,
        hackathon, relax, roadMap, review;
        ...
        t.chain(
            {
                ...
                waitFor : () => calendar.modes.month._overflowPopup?.containsFocus && t.query('.b-cal-event-wrap.b-active', calendar.modes.month.overflowPopup.element),
