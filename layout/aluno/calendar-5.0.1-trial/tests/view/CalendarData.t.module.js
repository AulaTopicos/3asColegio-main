import { DomHelper, EventStore, ResourceStore } from '../../build/calendar.module.js?457329';
...
StartTest(t => {
    ...
    t.it('Mode reordering', async t => {
        ...
        t.isDeeply(modeSelector.items.map(i => i.ref.split('ShowButton')[0]), ['agenda', 'year', 'month', 'week', 'day']);
